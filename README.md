...
The owner has accepted LifeIndex V1; `1.0.0` is being prepared for the [existing GitHub Pages URL](https://shushengritian.github.io/LifeIndex/). The owner confirmed phone-browser opening and explicitly deferred the remaining physical-iPhone checks under [ADR-0005](docs/adr/0005-v1-owner-acceptance.md). Deferred checks are not passed tests. See the [release handoff](docs/releases/v1.0.0.md), [follow-up register](docs/project/POST_V1_BACKLOG.md), and [PLAN.md](PLAN.md).
