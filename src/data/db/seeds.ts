...
const seedDescriptors: SeedDescriptor[] = [
  ...
  {
    id: 'category-activity-walking-v2',
    domain: 'activity',
    name: '步行',
    icon: 'walking',
    color: 'sage',
  ...
  {
    id: 'category-activity-running-v2',
    domain: 'activity',
    name: '跑步',
    icon: 'running',
    color: 'blue',
  ...
  {
    id: 'category-activity-cycling-v2',
    domain: 'activity',
    name: '骑行',
    icon: 'cycling',
    color: 'amber',
  ...
  {
    id: 'category-activity-strength-v2',
    domain: 'activity',
    name: '力量',
    icon: 'strength',
    color: 'rose',
