...
| ACT-001–004          | PRD §6.9                   | IA §9; HLD §12; LLD §10; ADR-0003; `docs/operations/PWA_AND_SHORTCUTS.md`                 | `src/app/actions`, `actionReceipts`           | 13 parser/atomic-service checks and dual-engine action-route E2E  | verified             |
